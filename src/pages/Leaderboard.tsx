          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <button
                ...
                className="flex items-center space-x-1 sm:space-x-2 py-1.5 sm:py-2 px-2 sm:px-4 rounded-lg text-black bg-space-accent hover:bg-space-accent/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-space-accent transition-all duration-200"
              >
