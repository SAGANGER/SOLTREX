...
const TASKS = [
  { id: 1, type: 'score', goal: 10, label: 'Faire un score de 10', xp: 100 },
  { id: 2, type: 'time', goal: 30, label: 'Jouer 30 secondes', xp: 100 },
  { id: 3, type: 'jump', goal: 10, label: 'Sauter 10 fois', xp: 100 },
  { id: 4, type: 'jump', goal: 20, label: 'Sauter 20 fois', xp: 100 },
  { id: 5, type: 'score', goal: 20, label: 'Faire un score de 20', xp: 100 },
  { id: 6, type: 'score', goal: 40, label: 'Faire un score de 40', xp: 100 },
  { id: 7, type: 'jump', goal: 30, label: 'Sauter 30 fois', xp: 100 },
  { id: 8, type: 'jump', goal: 40, label: 'Sauter 40 fois', xp: 100 },
  { id: 9, type: 'jump', goal: 50, label: 'Sauter 50 fois', xp: 100 },
  { id: 10, type: 'time', goal: 60, label: 'Jouer 60 secondes', xp: 100 },
  { id: 11, type: 'boost', goal: 1, label: 'Utiliser un boost', xp: 100 },
  { id: 12, type: 'boost', goal: 3, label: 'Utiliser 3 boosts', xp: 100 },
  { id: 13, type: 'level', goal: 2, label: 'Atteindre le niveau 2', xp: 100 },
  { id: 14, type: 'level', goal: 3, label: 'Atteindre le niveau 3', xp: 100 },
  { id: 15, type: 'games', goal: 3, label: 'Jouer 3 parties', xp: 100 },
  { id: 16, type: 'games', goal: 5, label: 'Jouer 5 parties', xp: 100 },
  { id: 17, type: 'score', goal: 100, label: 'Faire un score de 100', xp: 200 },
  { id: 18, type: 'jump', goal: 100, label: 'Sauter 100 fois', xp: 200 },
  { id: 19, type: 'time', goal: 180, label: 'Jouer 3 minutes', xp: 200 },
  { id: 20, type: 'level', goal: 5, label: 'Atteindre le niveau 5', xp: 200 },
];
    ...
    return (
      <div className="flex flex-col items-center space-y-4 sm:space-y-6 p-4 sm:p-6 bg-space-light/40 rounded-xl backdrop-blur-xl border border-space-accent/10 w-full max-w-md mx-auto mt-[-2rem] transition-all duration-300 hover:border-space-accent/30 hover:backdrop-blur-lg hover:shadow-[0_0_15px_-3px_rgba(153,69,255,0.3)]">
        <div className="text-center w-full">
          <h2 className="text-xl sm:text-2xl font-bold text-space-text-light mb-3 sm:mb-4">Flappy Bird</h2>
        ...
        <div className="flex flex-col space-y-3 sm:space-y-4 w-full">
                    ...
                    return (
                      <div key={id} className={`flex items-center p-2 rounded-lg border ${done ? (collected ? 'border-green-500 bg-green-900/30' : 'border-yellow-400 bg-yellow-900/20') : 'border-space-accent/20 bg-space-dark/80'} shadow transition-all`}> 
                        ...
                        <div className="ml-2 flex flex-col items-end">
                          ...
                          {done && collected && <span className="text-green-400 text-[10px] mt-0.5">Terminé !</span>}
                        </div>
                      </div>
                    );
                  })}
          ...
          <div className="flex justify-center space-x-3 sm:space-x-4 mt-2">
            <button
              onClick={startGame}
              className="px-3 sm:px-6 py-2 sm:py-2.5 bg-space-accent text-white rounded-xl hover:bg-space-accent/90 transition-all duration-200 hover:scale-105 font-bold text-xs sm:text-base w-32 sm:w-36"
            >
